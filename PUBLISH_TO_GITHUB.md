...
```bash
unzip uncle-matts-project-manageroo-v2026.8.13.2-source.zip
...
```bash
python3 scripts/smoke_release_install.py --archive /path/to/uncle-matts-project-manageroo-v2026.8.13.2.zip
```
...
```text
uncle-matts-project-manageroo-v2026.8.13.2.zip
uncle-matts-project-manageroo-v2026.8.13.2-source.zip
SHA256SUMS.txt
