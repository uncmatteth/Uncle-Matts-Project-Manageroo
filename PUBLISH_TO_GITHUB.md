...
```bash
unzip uncle-matts-project-manageroo-v2026.8.13.7-source.zip
...
Run the generated release ZIP smoke on each operating system you claim to support.
Manageroo supports Linux, macOS, and Windows through WSL2, so run this command
inside the corresponding Unix-like environment. Native Windows PowerShell is
an explicit unsupported-path check, not a supported installation lane:

```bash
python3 scripts/smoke_release_install.py --archive /path/to/uncle-matts-project-manageroo-v2026.8.13.7.zip
```
...
```text
uncle-matts-project-manageroo-v2026.8.13.7.zip
uncle-matts-project-manageroo-v2026.8.13.7-source.zip
SHA256SUMS.txt
