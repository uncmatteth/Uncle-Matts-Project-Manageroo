...
class PackageReleaseTests(unittest.TestCase):
    def test_release_names_use_project_manageroo_brand(self):
        ...
        self.assertEqual(package_release.DROP_ROOT, "uncle-matts-project-manageroo-v2026.7.17.1")
        self.assertNotEqual(package_release.DROP_ROOT, package_release.ARCHIVE_ROOT)
        self.assertEqual(package_release.INSTALLER_ZIP, "uncle-matts-project-manageroo-v2026.7.17.1.zip")
        self.assertEqual(package_release.SOURCE_ZIP, "uncle-matts-project-manageroo-v2026.7.17.1-source.zip")
    ...
    def test_package_release_runs_end_user_zip_smoke(self):
        ...
        self.assertIn('VERSION_TAG = "v2026.7.17.1"', smoke_text)
