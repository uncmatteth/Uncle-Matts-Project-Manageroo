...
class TruthContractTests(unittest.TestCase):
    ...
    def test_public_docs_and_installer_explain_lanes_without_pretending(self):
        surfaces = {
            ...
            "docs/ARCHITECTURE.md": [
                ...
                "Operator and worker boundaries", "It does not become repository-wide authority and does not block a later current request",
            ],
    ...
    def test_release_validation_keeps_truth_contract_in_the_package_gate(self):
        self.assertContainsAll(_read("scripts/verify_release.py"), [
            ...
            '"truth:production-overclaim-checker"', '"truth:worker-scope-boundary"',
    ...
    def test_overclaim_guard_rejects_negation_reversals(self):
        sentences = [
            ...
            "Manageroo does not merely claim full vision support; it delivers it.",
            "Manageroo does not pretend to have full vision support; it delivers it.",
            "Manageroo does not just promise full vision support; it delivers it.",
        ]
