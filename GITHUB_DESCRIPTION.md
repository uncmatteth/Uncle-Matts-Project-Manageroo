...
- `resume RUN_ID` continues an interrupted run from saved controller state, task checkpoints, and evidence instead of trusting chat memory or rerunning finished agent roles.
