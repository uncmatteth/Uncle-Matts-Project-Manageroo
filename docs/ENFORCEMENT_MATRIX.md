...
| External supervisor pollutes a plain target repo with Manageroo runtime files | Store external checkpoint and proof artifacts under Git metadata; keep `.manageroo/cache` for the Manageroo project lane | Preventive |
