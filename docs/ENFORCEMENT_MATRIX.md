...
| External fresh deletes uncheckpointed operator work | Require a compatible stopped/fix checkpoint and exact equality between current dirty paths and checkpoint-owned paths before source or ClawPatch state cleanup | Preventive; unowned dirty paths block unchanged |
