...
| Retryable release-sweep failure silently advances to another finding or retries forever | Verified stash, exact same-finding reopen, three total attempts, retained stopped checkpoint, and no final closure before success | Preventive and recoverable in controller |
