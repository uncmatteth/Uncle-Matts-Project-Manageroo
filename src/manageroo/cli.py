...
def parser() -> argparse.ArgumentParser:
    ...
    projects = sub.add_parser(
        "projects",
        help="Find local Git projects and print the right first MANAGEROO command.",
    )
    ...
    intent_capture = intent_sub.add_parser("capture", help="Write .manageroo/intent/INTENT-LOCK files.")
    ...
    brief = sub.add_parser(
        "brief",
        help="Turn a plain request into .manageroo/PRODUCT-BRIEF.md.",
    )
    ...
    banner = sub.add_parser("banner", help="Show the animated MANAGEROO terminal banner.")
