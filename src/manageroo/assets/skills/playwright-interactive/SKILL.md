...
description: "Use when user needs persistent browser and Electron interaction through `js_repl` for fast iterative UI debugging."
triggers:
  - "playwright interactive"
  - "persistent browser debugging"
  - "electron interaction debugging"
---
