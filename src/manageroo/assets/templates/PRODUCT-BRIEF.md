...
MANAGEROO runs local goal-style build and repair work. If this came from a
...
Describe what already exists, what is broken, and any areas that must be preserved.

## Ideas that may belong later

Capture possible future features here, or run:

```bash
manageroo idea add "Describe the idea"
```
